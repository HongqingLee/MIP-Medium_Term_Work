...
void CDib::SetWidth(long nWidth) 
{
	m_nWidth = nWidth;
}

void CDib::SetHeight(long nHeight)
{
	m_nHeight = nHeight;
}

void CDib::SetWidthBytes(int nWidthBytes)
{
	m_nWidthBytes = nWidthBytes;
}

void CDib::SetDibBits(unsigned char* pDibBits)
{
	m_pDibBits = pDibBits;
}

void CDib::SetBitCount(int nBitCount)
{
